...
# Sketch Line
# start = Point2D.Create(MM(-2383), MM(1625))
# end = Point2D.Create(MM(-2699), MM(1696.28953671542))
...
for line in lines:
    if line.Shape.Geometry.GetType() == Circle:
        ...
        points = calculate_intermediate_points(center, start, end, normal, STEP_ANGLE)
